...
/**
 * 
 *         rte represents route - an ordered list of waypoints representing a series of turn points leading to a
 *         destination.
 *       
 * 
 * <p>Java-Klasse für rteType complex type.
 * 
...
@XmlType(name = "rteType", namespace = "http://www.topografix.com/GPX/1/1", propOrder = {
    "name",
    "cmt",
    "desc",
    "src",
